...
//"TUDOOOOOOO que estiver na pasta data/fotos pode ser acessado pela URL /fotos"
app.use(
    "/fotos", //rota pública
    express.static(
...
app.get("/api/cachorros/:raca", (req, res) => {
    ...
    if(!cachorros[raca]){
        res.status(404).json({
            ...
            messagem: `Raça "${raca}" não encontrada`

        })
        //encerra a exercusão da rota
        return
    }
